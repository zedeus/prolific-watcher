...
export const DEFAULT_PRIORITY_FILTER_MIN_ESTIMATED_MINUTES = 0;
...
export const MIN_PRIORITY_FILTER_MIN_ESTIMATED_MINUTES = 0;
export const MAX_PRIORITY_FILTER_MIN_ESTIMATED_MINUTES = 240;
...
export const MAX_PRIORITY_FILTER_STUDY_IDS = 100;
export const STUDY_TYPE_STANDARD = 'standard';
export const STUDY_TYPE_ONGOING = 'ongoing';
export const STUDY_TYPE_SCREENING = 'screening';
export const ALL_STUDY_TYPES = [STUDY_TYPE_STANDARD, STUDY_TYPE_ONGOING, STUDY_TYPE_SCREENING] as const;
